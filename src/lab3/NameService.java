...
public class NameService {
     ...
     */
    public String extractFirstName(String fullName) throws IllegalNameException {
        String[] nameParts = fullName.split(" ");
     ...
     */
    public int getNameLength(String name) throws IllegalNameException {
         if(name == null || name.isEmpty()){
            throw new IllegalNameException("Invalid Input");
        }
